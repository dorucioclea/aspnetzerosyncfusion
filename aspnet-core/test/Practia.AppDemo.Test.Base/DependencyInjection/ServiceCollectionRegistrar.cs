...
namespace Practia.AppDemo.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<AppDemoDbContext>>()
            ...
            new AppDemoDbContext(builder.Options).Database.EnsureCreated();
        }
