...
using Practia.AppDemo.Features;
using Practia.AppDemo.Test.Base;
using Shouldly;
using Xunit;

namespace Practia.AppDemo.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(AppDemoConsts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
