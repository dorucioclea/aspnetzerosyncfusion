...
using Practia.AppDemo.MultiTenancy.HostDashboard;
...
namespace Practia.AppDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(AppDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
