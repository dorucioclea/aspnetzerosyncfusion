...
using Practia.AppDemo.Web.Models.TokenAuth;
using Practia.AppDemo.Authorization.Impersonation;
using Practia.AppDemo.Authorization.Roles;
using Practia.AppDemo.Configuration;
using Practia.AppDemo.Debugging;
using Practia.AppDemo.Identity;
using Practia.AppDemo.Net.Sms;
using Practia.AppDemo.Notifications;
using Practia.AppDemo.Security.Recaptcha;
using Practia.AppDemo.Web.Authentication.External;
using Practia.AppDemo.Web.Common;

namespace Practia.AppDemo.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : AppDemoControllerBase
    {
