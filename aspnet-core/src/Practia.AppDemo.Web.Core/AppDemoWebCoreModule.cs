...
using Practia.AppDemo.Web.Authentication.JwtBearer;
using Practia.AppDemo.Web.Authentication.TwoFactor;
using Practia.AppDemo.Web.Chat.SignalR;
using Practia.AppDemo.Web.Configuration;
using Practia.AppDemo.Web.DashboardCustomization;

namespace Practia.AppDemo.Web
{
    [DependsOn(
        typeof(AppDemoApplicationModule),
        typeof(AppDemoEntityFrameworkCoreModule),
    ...
    public class AppDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AppDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AppDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AppDemoWebCoreModule).GetAssembly());
        }
