...
namespace Practia.AppDemo.Core.Base
{
    public abstract class AppDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected AppDemoQueryBase(string fieldName,
