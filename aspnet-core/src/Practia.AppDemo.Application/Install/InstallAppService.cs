...
using Practia.AppDemo.Migrations.Seed.Host;
...
namespace Practia.AppDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AppDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AppDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(AppDemoConsts.ConnectionStringName).Value.ToString();
        }
