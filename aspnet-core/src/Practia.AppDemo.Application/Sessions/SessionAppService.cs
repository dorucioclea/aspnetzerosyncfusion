...
{
    public class SessionAppService : AppDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = AppDemoConsts.Currency,
                    CurrencySign = AppDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = AppDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };
