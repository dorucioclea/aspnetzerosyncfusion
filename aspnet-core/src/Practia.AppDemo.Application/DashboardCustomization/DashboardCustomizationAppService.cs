...
using Practia.AppDemo.DashboardCustomization.Definitions;
using Practia.AppDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Practia.AppDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AppDemoAppServiceBase, IDashboardCustomizationAppService
    {
