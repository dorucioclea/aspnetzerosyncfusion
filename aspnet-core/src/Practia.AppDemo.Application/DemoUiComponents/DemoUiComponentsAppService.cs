...
using Practia.AppDemo.DemoUiComponents.Dto;

namespace Practia.AppDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : AppDemoAppServiceBase, IDemoUiComponentsAppService
    {
