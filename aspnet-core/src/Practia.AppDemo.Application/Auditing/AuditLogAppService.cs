...
using Practia.AppDemo.Auditing.Exporting;
...
using EntityHistoryHelper = Practia.AppDemo.EntityHistory.EntityHistoryHelper;

namespace Practia.AppDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AppDemoAppServiceBase, IAuditLogAppService
    {
