...
using Practia.AppDemo.Authentication.TwoFactor.Google;
using Practia.AppDemo.Authorization.Users.Dto;
using Practia.AppDemo.Authorization.Users.Profile.Cache;
using Practia.AppDemo.Authorization.Users.Profile.Dto;
using Practia.AppDemo.Friendships;
using Practia.AppDemo.Gdpr;
using Practia.AppDemo.Identity;
using Practia.AppDemo.Net.Sms;
using Practia.AppDemo.Security;
using Practia.AppDemo.Storage;
using Practia.AppDemo.Timing;

namespace Practia.AppDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AppDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Practia.AppDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Practia.AppDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
