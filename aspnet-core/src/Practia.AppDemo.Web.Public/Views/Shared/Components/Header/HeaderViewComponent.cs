...
using Practia.AppDemo.Web.Public.Startup;
using Practia.AppDemo.Web.Session;

namespace Practia.AppDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AppDemoViewComponent
    {
