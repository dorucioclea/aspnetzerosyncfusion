...
namespace Practia.AppDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(AppDemoWebCoreModule)
    )]
    public class AppDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AppDemoWebFrontEndModule(IWebHostEnvironment env, AppDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AppDemoWebFrontEndModule).GetAssembly());
        }
    }
}
