...
using Practia.AppDemo.EntityFrameworkCore.Repositories;

namespace Practia.AppDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : AppDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AppDemoDbContext> dbContextProvider)
