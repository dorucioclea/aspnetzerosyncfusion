...
using MvvmHelpers;
using Practia.AppDemo.Authorization.Users.Profile;
using Practia.AppDemo.Authorization.Users.Profile.Dto;
using Practia.AppDemo.Commands;
using Practia.AppDemo.Core.Threading;
using Practia.AppDemo.Models.NavigationMenu;
using Practia.AppDemo.Services.Navigation;
using Practia.AppDemo.ViewModels.Base;
using Plugin.Media;
...
using Practia.AppDemo.Controls;
using Practia.AppDemo.Dto;
using Practia.AppDemo.Extensions;
using Practia.AppDemo.Localization;
using Practia.AppDemo.UI;
using Practia.AppDemo.UI.Assets;
using Practia.AppDemo.Views;
using DependencyResolver = Practia.AppDemo.Core.Dependency.DependencyResolver;

namespace Practia.AppDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "AppDemo";
