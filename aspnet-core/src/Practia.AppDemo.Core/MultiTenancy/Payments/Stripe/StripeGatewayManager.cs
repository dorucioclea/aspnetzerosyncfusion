...
namespace Practia.AppDemo.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : AppDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "AppDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AppDemoConsts.Currency;
        }
