...
namespace Practia.AppDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AppDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Practia.AppDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
